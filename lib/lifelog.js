...
window.addEventListener('resize', () => {
    ...
    const inputHeight = document.querySelector('.log-input').offsetHeight;
    document.querySelector('.log-container').style.height = `${viewportHeight - inputHeight - 20}px`; // 20px for margin/padding adjustment
});

// Call it on page load or when needed
